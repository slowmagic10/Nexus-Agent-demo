const FIELD_LABELS = Object.freeze({
  ...
  "provider.contextWindowTokens": "模型窗口容量",
  "provider.contextTargetTokens": "输入目标",
  "provider.maxOutputTokens": "输出上限",
  "provider.outputTokenParameter": "输出参数",
  "provider.streamUsage": "流式用量",
